...
// Local
import styleVars from '~Styles/abstract/_variables';
...
const theme = createMuiTheme({
  palette: {
    ...
    text: {
      ...
      hint: styles.fontColorSecondary,
      disabled: styles.fontColorSecondary,
    },
  },
  typography: {
...
export { theme, styles, useAppTheme, AppTheme };
